...
class QAgent(Agent):
    def init(self):
        ...
        self.bellmanQ = OrderedDict(zip(self.stateIds, self.rng.rand(Qshape[0], Qshape[1])))

        # print "bellman q initially"
        # print self.bellmanQ[10]
        # exit()

        self.curStateId = 10  # initially it is right (right is 0, left is 1)
    ...
    def sense(self, grid):
        ...
        self.nextStateId = self.stateIds[int(self.isLeft(grid))]
